...
<TR>
	...
	<TR BGCOLOR="<?php echo $FrameColor ?>">
		...
		<TR>
			...
			<B><?php echo $MakeSticky ? "Prilepljeno!" : "Odlepljeno!"; ?></B><BR>
...
$db->query("UPDATE frmTopics SET Sticky=". ($MakeSticky ? 1 : 0) ." WHERE ID=". $_GET['Tema']);
?>
