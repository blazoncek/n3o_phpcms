...
//	(ie50 ? "filter: none;" : "") +
//	"'>";
	var str = "<table border=0 cellpadding=0 cellspacing=0 id='" + this.id + "' class='webfx-menu'><tr><td>";
...
function WebFXMenuItem(sText, sHref, sTarget, sIcon, oSubMenu, sToolTip) {
...
WebFXMenuItem.prototype.toString = function () {
	return	"<a" +
			...
			"<img class=\"icon\" src=\"" + webfxMenuImagePath + (this.icon==null || this.icon=="" ? "trans.gif" : this.icon ) + "\" width=16 height=16 border=0 align=\"absmiddle\">" +
			this.text + "&nbsp;&nbsp;&nbsp;&nbsp;" +
			"</a>";
};
...
//	var str = "<div id='" + this.id + "' class='webfx-menu-bar'>";
	var str = "<table border=0 cellpadding=2 cellspacing=0 width='100%' id='" + this.id + "' class='webfx-menu-bar'><tr>";

	// loop through all menuButtons
	for (var i = 0; i < this._menuItems.length; i++)
		str += "<td" + (i==this._menuItems.length-1 ? " align='right' nowrap width=99%" : "") + "><nobr>" + this._menuItems[i] + "</nobr></td>";
...
function WebFXMenuButton(sText, sHref, sTarget, sIcon, oSubMenu, sToolTip) {
	this._parentConstructor = WebFXMenuItem;
	this._parentConstructor(sText, sHref, sTarget, sIcon, oSubMenu, sToolTip);
}
...
WebFXMenuButton.prototype.toString = function () {
	return	"<a" +
			...
			">" +
			"<img class='icon' src=\"" + webfxMenuImagePath + (this.icon!=null && this.icon!="" ? this.icon : "trans.gif" ) + "\" width=" + (this.icon!=null && this.icon!="" ? 16 : 0) + " height=16 border=0 align=\"absmiddle\">" +
			this.text + "&nbsp;" +
			(this.subMenu ? " <img class='arrow' src=\"" + webfxMenuImagePath + "arrow.down.gif\" align='absmiddle'>" : "") +
			"</a>";
};
