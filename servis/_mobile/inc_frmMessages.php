...
if ( isset($_GET['Check']) ) {
	...
	//echo "<h4>Approve message?</h4>\n";
	echo "<p>". $Msg ."</p>\n";
	if ( !$IsApproved )
		echo "<a href=\"". $_SERVER['PHP_SELF'] ."?". $_SERVER['QUERY_STRING'] ."&Approve=". (int)$_GET['Check'] ."\" data-role=\"button\" data-ajax=\"false\" data-theme=\"b\">Approve</a>\n";
	...
	echo "<div id=\"messages\" data-role=\"page\" data-title=\"Messages\">\n";
	...
	if ( $List ) {
		...
		foreach ( $List as $Item ) {
			...
			echo "<li>";
			if ( $Item->Locked )
				echo "<img src=\"pic/icon.lock.png\" alt=\"Locked\" class=\"ui-li-icon\">";
			else 
