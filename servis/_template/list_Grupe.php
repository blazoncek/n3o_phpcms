	...
	while ( $i < $EndR ) {
		...
		if ( $Item->GroupID != 1 || contains($ActionACL,"D") ) {
			...
			if ( $Item->GroupID > 4 && contains($ActionACL,"D") )
				echo "<a href=\"javascript:void(0);\" onclick=\"javascript:check('$Item->GroupID','$Item->Name');\"><img src=\"pic/list.delete.gif\" width=11 height=11 alt=\"Briši\" border=\"0\" align=\"absmiddle\" class=\"icon\"></a>";
			else
				echo "&nbsp;";
			echo "</td>\n";
			echo "</tr>\n";
