<?php
/*~ inc_medCategories.php - Display media attachment categories.
.---------------------------------------------------------------------------.
...
if ( !$List ) 
	...
	foreach ( $List as $Item ) {
		...
		if ( contains($ACL,"W") ) {
			echo "<A HREF=\"javascript:void(0);\" ONCLICK=\"$('#divRubrike').load('inc.php?Izbor=".$_GET['Izbor']."&MediaID=".$_GET['MediaID']."&Odstrani=$Item->ID');\"><IMG SRC=\"pic/list.delete.gif\" WIDTH=11 HEIGHT=11 ALT=\"Delete\" BORDER=\"0\" CLASS=\"icon\"></A>";
		}
		echo "</TD>\n";
		echo "</TR>\n";
		$CurrentRow++;
