...
if ( isset($_GET['Find']) && $_GET['Find'] != "" ) {
	...
	if ( !$List ) 
		echo "<TR><TD ALIGN=\"center\" COLSPAN=\"3\">Ni izbranih predlog!</TD></TR>\n";
	else {
		$CurrentRow = 1;
		$RecordCount = count( $List );
		foreach ( $List as $Item ) {
			...
			echo "<TD>";
			if ( contains($rACL,"R") )
				echo "<A HREF=\"javascript:void(0);\" ONCLICK=\"loadTo('Edit','edit.php?Izbor=Predloge&ID=$Item->PredlogaID');\">";
			if ( contains($rACL,"L") )
				echo $Item->Naziv;
			else
