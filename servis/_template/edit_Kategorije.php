...
$(document).ready(function(){
		...
		add: function(e, data) {
			...
			switch ( data.context.attr("id") ) {
			  ...
			  case 'thumbImage' :
				...
				break;
			  case 'divMe' :
			  	data.context.load('inc.php?Izbor=KategorijeMedia&KategorijaID=<?php echo $_GET['ID'] ?>');
				break;
			}
        }
    });
	...
	// load subdata
	if ( $("#divLe").text() ) $("#divLe").load('inc.php?Izbor=KategorijeVsebina&KategorijaID=<?php echo $_GET['ID'] ?>&Ekstra=2');
	if ( $("#divCe").text() ) $("#divCe").load('inc.php?Izbor=KategorijeVsebina&KategorijaID=<?php echo $_GET['ID'] ?>&Ekstra=0');
	if ( $("#divDe").text() ) $("#divDe").load('inc.php?Izbor=KategorijeVsebina&KategorijaID=<?php echo $_GET['ID'] ?>&Ekstra=1');
	if ( $("#divBe").text() ) $("#divBe").load('inc.php?Izbor=KategorijeBesedila&KategorijaID=<?php echo $_GET['ID'] ?>');
	if ( $("#divMe").text() ) $("#divMe").load('inc.php?Izbor=KategorijeMedia&KategorijaID=<?php echo $_GET['ID'] ?>');
