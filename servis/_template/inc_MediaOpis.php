...
$(document).ready(function(){
	...
	$("form[name='MediaOpis']").submit(function(){
...
<FORM NAME="MediaOpis" ACTION="inc.php?Izbor=<?php echo $_GET['Izbor'] ?>&MediaID=<?php echo $_GET['MediaID'] ?>&ID=<?php echo $_GET['ID'] ?>" METHOD="post" onsubmit="return void(0);">
<?php if ( $Podatek ) : ?>
...
$All = $db->get_var(
	...
	if ( !($All) )
		echo "<OPTION VALUE=\"\"".(($Podatek->Jezik == "")? " SELECTED": "").">- za vse -</OPTION>\n";
