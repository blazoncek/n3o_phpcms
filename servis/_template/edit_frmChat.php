<?php
/*~ edit_frmChat.php - Edit forum chat-rooms
.---------------------------------------------------------------------------.
...
<LEGEND ID="lgdData">
	...
	<TR>
		<TD ALIGN="right" COLSPAN="2" STYLE="margin-top:3px;padding-top:3px;border-top:silver solid 1px;"><INPUT TYPE="Submit" VALUE="Zapiši" TABINDEX="1" CLASS="but"></TD>
	</TR>
	</FORM>
	</TABLE>
</FIELDSET>
