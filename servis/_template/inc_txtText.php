...
<TR>
	...
	<TD>
	&nbsp;Language: <B class="red"><?php echo ($_GET['Jezik']==""? "all": $_GET['Jezik']) ?></B>
	<INPUT TYPE="Hidden" NAME="Jezik" VALUE="<?php echo $_GET['Jezik'] ?>">
	</TD>
	<TD ALIGN="right">
	<INPUT TYPE="Button" VALUE=" Close " ONCLICK="loadTo('Edit','edit.php?Izbor=Text&ID=<?php echo (int)$_GET['BesediloID'] ?>')" CLASS="but">
