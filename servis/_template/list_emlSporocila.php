...
if ( count( $List ) == 0 ) {
	...
	while ( $i < $EndR ) {
		...
		if ( contains($ACL,"L") ) {
			...
			echo "<td align=\"center\" class=\"f10\">". date("j.n.y",sqldate2time($Item->Datum)). "</td>\n";
			echo "<td align=\"right\" valign=\"top\" width=\"20\">";
			if ( contains($ACL,"D") )
				echo "<a href=\"javascript:void(0);\" onclick=\"javascript:check('$Item->emlMessageID','$Item->Naziv');\"><img src=\"pic/list.delete.gif\" width=11 height=11 alt=\"Briši\" border=\"0\" align=\"absmiddle\" class=\"icon\"></a>";
			else
				echo "&nbsp;";
			echo "</td>\n";
			echo "</tr>\n";
