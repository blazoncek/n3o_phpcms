...
if ( count( $List ) == 0 ) {
	...
	while ( $i < $EndR ) {
		...
		if ( contains($ActionACL,"D") && $Item->ID > 1 )
			echo "<a href=\"javascript:void(0);\" onclick=\"javascript:check('$Item->ID','$Item->Name');\"><img src=\"pic/list.delete.gif\" width=11 height=11 alt=\"Briöi\" border=\"0\" align=\"absmiddle\" class=\"icon\"></a>";
		else
